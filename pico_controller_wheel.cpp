...
Wheel_controller Left_Wheel(L_Kp  ,L_Ki ,L_Kd  , PID_dt_sec ,L_min, L_max, Left_Encoder_A_Pin  , Left_Encoder_B_Pin  , Left_Motor_PWM_Pin  , Left_Motor_Dir_Pin);
Wheel_controller Right_Wheel(R_Kp ,R_Ki ,R_Kd  , PID_dt_sec ,R_min, R_max, Right_Encoder_A_Pin , Right_Encoder_B_Pin , Right_Motor_PWM_Pin , Right_Motor_Dir_Pin);
...
void timer_callback(rcl_timer_t *timer, int64_t last_call_time)
{
    ...
    L_wheel_counter_msg.data = Left_Wheel.getTicks();
    R_wheel_counter_msg.data = Right_Wheel.getTicks();
...
int main()
{
    ...
    //add_repeating_timer_ms(PID_dt, timer_callback, NULL, &PID_timer);
